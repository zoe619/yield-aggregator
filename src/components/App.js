...
class App extends Component {
    ...
    async withdrawHandler() {
        ...
        this.state.aggregator.methods.withdraw().send({ from: this.state.account })
            .on('transactionHash', () => {
                this.loadAccountInfo()
            })
    }
    ...
    render() {
        return ( <
            ...
            div className = "col" >
            <
            h1 className = "my-5" > Let YOMO get you the best APY < /h1> <
            ...
            placeholder = "Amount"
            onChange = {
                (e) => this.setState({ amountToDeposit: e.target.value }) }
            /> <
